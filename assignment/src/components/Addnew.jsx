...
const Addnew = () => {
  ...
  const handleSubmit=(e)=>{
    ...
    // console.log({name,id,email,phone,isActive});
    fetch("http://localhost:8000/employee",{
      method:"POST",
      "headers":{"content-typt":"applicationn/json"},
...
//           </div>
//           <div className="mb-4">
//             <label htmlFor="name" className="block mb-1 text-sm font-medium text-gray-700">Phone</label>
//             <input
//               type="text"
...
//        <div className="">
//        <button type="submit" className="px-4 py-2 ml-6 mr-6 text-white transition-colors duration-300 bg-red-500 rounded-md hover:bg-red-600">
//             Save
//           </button>
//          <NavLink to='/'>
//          <button type="submit" className="px-4 py-2 text-white transition-colors duration-300 bg-blue-500 rounded-md hover:bg-blue-600">
//             Back
//           </button>
//           </NavLink> 
//        </div>
